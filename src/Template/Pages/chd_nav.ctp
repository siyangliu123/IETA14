    ...
    <li class="cards__item">
        <div class="card">
            ...
            <div class="card__content">
                ...
                <?php echo $this->Html->link("View Diet Advice", ['controller' => 'foods', 'action' => 'healthy_nutrition'], ['class' => 'btn btn--block card__btn btn-primary']); ?>
            </div>
        </div>
    </li>
    <li class="cards__item">
        <div class="card">
            ...
            <div class="card__content">
                ...
                <?php echo $this->Html->link("View Exercise Advice", ['controller' => 'pages', 'action' => 'exercise'], ['class' => 'btn btn--block card__btn btn-primary']); ?>
            </div>
        </div>
    </li>
    <li class="cards__item">
        <div class="card">
            ...
            <div class="card__content">
                ...
                <?php echo $this->Html->link("View Calorie Calculator", ['controller' => 'foods', 'action' => 'calculator'], ['class' => 'btn btn--block card__btn btn-primary']); ?>
            </div>
        </div>
    </li>
</ul>